...
class JwtAuthenticationFilterTest {
    ...
    @Test
    void doFilterInternalInvalidAuthorizationHeaderFormat() throws ServletException, IOException {
        when(request.getHeader("Authorization")).thenReturn("Basic randomtoken123");
